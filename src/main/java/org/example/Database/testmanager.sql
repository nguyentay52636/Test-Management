...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th3 15, 2025 lúc 03:56 AM
...
('ENG01', 'A', 'ENG01A', '424,426,429,432,434,427,430,433,447,457,458,459'),
('HIST01', 'A', 'HIST01A', '464,467,473,475,483,465,470,476,479,493'),
('MATH01', 'A', 'MATH01A', '384,386,389,392,394,385,390,393,405,416');
...
(2, 'MATH01', 'Math Practice Test 1', 10, 1, '2025-03-14', 1),
(4, 'HIST01', 'History Practice Test 1', 10, 1, '2025-03-14', 1);
...
--
ALTER TABLE `result`
  MODIFY `rs_num` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
