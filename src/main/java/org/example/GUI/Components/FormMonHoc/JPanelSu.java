...
public class JPanelSu extends JPanel {
    ...
    private void initComponents() {
        ...
        lblTableTitle.setBounds(324, 227, 200, 30);
        add(lblTableTitle);
        // Tìm kiếm câu hỏi
        ...
        btnBack.setBounds(752, 616, 191, 51);
    ...
    private void loadDataFromDatabase() {
        ...
        List<QuestionDTO> questions = questionDAO.getQuestionsByTopic(2); // Chỉ lấy những câu hỏi có QTopicID = 1
    ...
    private void importDataFromExcel() {
        String filePath = "D:/tracnghiemSu.xlsx"; // Đường dẫn file Excel
