        ...
        public AddButtonAccount(String _type) {
                ...
                button2.setIcon(new ImageIcon(
                                getClass().getResource(
                                                "/org/example/GUI/resources/images/icons8_police_badge_30px.png")));
                ...
                if (_type.equals("Thêm")) {
                        ...
                        btnSua.setIcon(new ImageIcon(
                                        this.getClass().getResource(
                                                        "/org/example/GUI/resources/images/icons8_support_30px.png")));
                        plButton.add(btnSua);
                }
                btnHuy.setIcon(new ImageIcon(
                                this.getClass().getResource(
                                                "/org/example/GUI/resources/images/icons8_cancel_30px_1.png")));
                plButton.add(btnHuy);
